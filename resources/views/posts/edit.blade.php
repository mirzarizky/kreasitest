    ...
    <form action="{{ route('posts.update', $post->slug) }}" method="POST">
        ...
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12 dark:border-white/10">
                ...
                <h2 class="text-base/7 font-semibold text-gray-900 dark:text-white mt-2">Edit Post</h2>
                <p class="mt-1 text-sm/6 text-gray-600 dark:text-gray-400">
                    Review and refine your post as needed.
                </p>
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="col-span-full">
                        ...
                        <div class="mt-2">
                            <div
                                ...
                                <input id="title" type="text" name="title" placeholder="Post Title" value="{{ $post->title }}"
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="mt-2">
                            <div
                                class="flex items-center rounded-md bg-white pl-3 outline-1 -outline-offset-1 outline-gray-300 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600 dark:bg-white/5 dark:outline-white/10 dark:focus-within:outline-indigo-500">
                                <input id="author" type="text" name="author" placeholder="Author" required val
                                    value="{{ $post->author }}"
                                    class="block min-w-0 grow bg-white py-1.5 pl-1 pr-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline-0 sm:text-sm/6 dark:bg-transparent dark:text-white dark:placeholder:text-gray-500" />
                            </div>
                        </div>
                    ...
                    <div class="col-span-full">
                        <div class="relative min-w-sm max-w-full">
                            ...
                            <input datepicker id="default-datepicker" type="date" value="{{ $post->published_at->format('Y-m-d') }}"
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            ...
            <button type="submit"
                class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 dark:bg-indigo-500 dark:shadow-none dark:focus-visible:outline-indigo-500">
                Save changes
            </button>
        </div>
    </form>
